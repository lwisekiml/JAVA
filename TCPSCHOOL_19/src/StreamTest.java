...
/*
# 요소의 연산 : sum(), average()
IntStream이나 DoubleStream과 같은 기본 타입 스트림에는 해당 스트림의 모든 요소에 대해 합과 평균을 구할 수 있는 sum()과 average() 메소드가 각각 정의되어 있음
average() 메소드는 각 기본 타입으로 래핑 된 Optional 객체를 반환함
*/
		System.out.println("\n--- 요소의 연산 ---");
		IntStream s11 = IntStream.of(30, 90, 70, 10);
		DoubleStream s22 = DoubleStream.of(30.3, 90.9, 70.7, 10.1);
		
		System.out.println(s11.sum());
		System.out.println(s22.average().getAsDouble());
	}
}
